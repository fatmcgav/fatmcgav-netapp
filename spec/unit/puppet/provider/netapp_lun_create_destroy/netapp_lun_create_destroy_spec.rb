...
describe Puppet::Type.type(:netapp_lun_create_destroy).provider(:netapp_lun_create_destroy) do
  ...
  before :each do
    ...
    Puppet::Type.type(:netapp_lun_create_destroy).stubs(:defaultprovider).returns described_class
  end
  ...
  let :create_lun do
    Puppet::Type.type(:netapp_lun_create_destroy).new(
