...
describe Puppet::Type.type(:netapp_lun_clone_destroy).provider(:netapp_lun_clone_destroy) do
  ...
  before :each do
    ...
    Puppet::Type.type(:netapp_lun_clone_destroy).stubs(:defaultprovider).returns described_class
  end
  ...
  let :clone_lun do
    Puppet::Type.type(:netapp_lun_clone_destroy).new(
