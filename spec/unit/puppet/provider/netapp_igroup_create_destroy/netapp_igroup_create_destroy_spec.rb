...
describe Puppet::Type.type(:netapp_igroup_create_destroy).provider(:netapp_igroup_create_destroy) do
  ...
  before :each do
    ...
    Puppet::Type.type(:netapp_igroup_create_destroy).stubs(:defaultprovider).returns described_class
  end
  ...
  let :create_igroup do
    Puppet::Type.type(:netapp_igroup_create_destroy).new(
  ...
  describe "destroy the igroup" do
    it ":should be able to destroy igroup" do
      destroy_igroup.provider.should be_exists
