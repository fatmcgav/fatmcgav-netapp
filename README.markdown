...
[![Coverage Status](https://coveralls.io/repos/fatmcgav/fatmcgav-netapp/badge.png?branch=v0.4-fixes)](https://coveralls.io/r/fatmcgav/fatmcgav-netapp?branch=branch=v0.4-fixes)
